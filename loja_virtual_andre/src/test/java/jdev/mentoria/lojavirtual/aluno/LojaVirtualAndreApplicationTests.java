...
import jdev.mentoria.lojavirtual.aluno.controller.AcessoController;
...
@Profile("test")
@SpringBootTest(classes = LojaVirtualAndreApplication.class)
class LojaVirtualAndreApplicationTests extends TestCase {
